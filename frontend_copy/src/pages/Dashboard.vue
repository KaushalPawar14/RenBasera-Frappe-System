...
import api from "../utils/api.js"; // Standard Axios instance
...
const allActions = [
	// ... (Keep your existing allActions array here) ...
];
...
async function fetchStats() {
	...
	try {
		...
		// Use standard Frappe /api/resource/ endpoint with Axios params
		const res = await api.get("/api/resource/TSF Dispatch Challan", {
			params: {
				fields: JSON.stringify(["name", "vehicle", "workflow_state", "creation"]),
				filters: JSON.stringify([["creation", "like", `${today}%`]]),
